...
```mermaid
flowchart TD
    A["เริ่มโปรแกรม เมนูตัวดำเนินการ"] --> B["แสดงเมนู 1-5\nรับค่าตัวเลือกเป็น key"]
    B --> C["รับค่าตัวเลข a และ b"]
    C --> D{key คืออะไร?}
    D -- "1" --> E1["แสดงผลบวก a + b"]
    D -- "2" --> E2["แสดงผลลบ a - b"]
    D -- "3" --> E3["แสดงผลคูณ a * b"]
    D -- "4" --> E4["แสดงผลหาร a / b"]
    D -- "5" --> E5["แสดงผลหารเอาเศษ a % b"]
    D -- "อื่นๆ" --> F["แสดงข้อผิดพลาดในการเลือก"]
    E1 --> G["แสดงข้อความ 'แล้วเจอกันใหม่!'"]
    E2 --> G
    E3 --> G
    E4 --> G
    E5 --> G
